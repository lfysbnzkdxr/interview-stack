...
| 类别 | 技术 |
|---|---|
| UI | Jetpack Compose + Material 3（自适应图标、深浅色主题） |
...
# 运行单元测试（78 个，含 LLM / WebDAV / 仓库 / ViewModel 层）
...
GitHub Actions 在每次 push / PR 时自动运行单元测试、Lint 和 Debug 构建，并上传 Lint 报告与 APK 产物。
